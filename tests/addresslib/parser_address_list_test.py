...
def test_simple_valid():
    ...
    s = '''"Allan Nasong\'o"  <nasongoallan@yahoo.com>, "Osozi Wilfred" <osoziwilfred@yahoo.com>'''
    addrs = address.parse_list(s)

    assert_equal(2, len(addrs))

    assert_equal(addrs[0].addr_type, 'email')
    assert_equal(addrs[0].display_name, '"Allan Nasong\'o"')
    assert_equal(addrs[0].address, 'nasongoallan@yahoo.com')
    assert_equal(addrs[0].full_spec(), '"Allan Nasong\'o" <nasongoallan@yahoo.com>')

    assert_equal(addrs[1].addr_type, 'email')
    assert_equal(addrs[1].display_name, '"Osozi Wilfred"')
    assert_equal(addrs[1].address, 'osoziwilfred@yahoo.com')
    assert_equal(addrs[1].full_spec(), '"Osozi Wilfred" <osoziwilfred@yahoo.com>')
    ...
    s = "admin@mailgunhq.com,lift@malltip.com"
    addrs = address.parse_list(s)
    ...
    assert_equal(addrs[1].address, 'lift@malltip.com')
    assert_equal(addrs[1].full_spec(), 'lift@malltip.com')
