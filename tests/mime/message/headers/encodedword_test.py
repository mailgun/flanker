...
def happy_mime_to_unicode_test():
    ...
    v = ' =?US-ASCII?Q?Keith_Moore?= <moore@cs.utk.edu>'
    eq_(u'Keith Moore <moore@cs.utk.edu>', encodedword.mime_to_unicode(v))
...
def corrupted_headings_test():
    v = '=?utf-8?b?IumrlOiCsuWckuWNgOermSDihpIg6ZW35bqa6Yar6Zmi56uZIOKGkiDmlofljJbk?=\n =?utf-8?b?uInot6/nq5kiIDx2Z3hkcmp5Y2lAZG5zLmh0Lm5ldC50dz4=?='
    eq_(u'"體育園區站 → 長庚醫院站 → 文化¸‰è·¯ç«™" <vgxdrjyci@dns.ht.net.tw>', encodedword.mime_to_unicode(v))
...
def various_encodings_test():
    v = '"=?utf-8?b?6ICD5Y+W5YiG5Lqr?=" <Ernest.Beard@msa.hinet.net>'
    eq_(u'"考取分享" <Ernest.Beard@msa.hinet.net>', encodedword.mime_to_unicode(v))
