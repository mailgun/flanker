...
def missing_newline_test():
    mime = "From: Hacker Apply API <hello@agilediagnosis.com>\r\nTo: Agile Support <kurt@agilediagnosis.com>\r\nMIME-Version: 1.0\r\nContent-type: text/html\r\nSubject: Hacker application from Kurt the Viking\r\nA new job application was submitted to the hacker API <br /><br /><strong>Name:</strong> Kurt the Viking<br /><strong>Email:</strong> sirmixalot@awesome.com<br /><strong>Referred by:</strong> HN<br /><strong>Position:</strong> DJ Snapz<br /><br /><strong>About...</strong><br />Pretty much the best snapper ever. Awww SNAP!<br /><br /><strong>Why Agile...</strong><br />You know you love snapping. So do I. Let's do this.<br /><br /><strong>Sample Work:</strong> <br />http://google.com<br />http://amazon.com<br />\r\n.\r\n"
    message = scan(mime)
    eq_("A new job application was submitted to the hacker API <br /><br /><strong>Name:</strong> Kurt the Viking<br /><strong>Email:</strong> sirmixalot@awesome.com<br /><strong>Referred by:</strong> HN<br /><strong>Position:</strong> DJ Snapz<br /><br /><strong>About...</strong><br />Pretty much the best snapper ever. Awww SNAP!<br /><br /><strong>Why Agile...</strong><br />You know you love snapping. So do I. Let's do this.<br /><br /><strong>Sample Work:</strong> <br />http://google.com<br />http://amazon.com<br />\r\n.\r\n", message.body)

    # check that works with mixed-style-newlines
    mime = "From: Hacker Apply API <hello@agilediagnosis.com>\r\nTo: Agile Support <kurt@agilediagnosis.com>\r\nMIME-Version: 1.0\r\nContent-type: text/html\r\nSubject: Hacker application from Kurt the Viking\nA new job application was submitted to the hacker API <br /><br /><strong>Name:</strong> Kurt the Viking<br /><strong>Email:</strong> sirmixalot@awesome.com<br /><strong>Referred by:</strong> HN<br /><strong>Position:</strong> DJ Snapz<br /><br /><strong>About...</strong><br />Pretty much the best snapper ever. Awww SNAP!<br /><br /><strong>Why Agile...</strong><br />You know you love snapping. So do I. Let's do this.<br /><br /><strong>Sample Work:</strong> <br />http://google.com<br />http://amazon.com<br />"
    message = scan(mime)
    eq_("A new job application was submitted to the hacker API <br /><br /><strong>Name:</strong> Kurt the Viking<br /><strong>Email:</strong> sirmixalot@awesome.com<br /><strong>Referred by:</strong> HN<br /><strong>Position:</strong> DJ Snapz<br /><br /><strong>About...</strong><br />Pretty much the best snapper ever. Awww SNAP!<br /><br /><strong>Why Agile...</strong><br />You know you love snapping. So do I. Let's do this.<br /><br /><strong>Sample Work:</strong> <br />http://google.com<br />http://amazon.com<br />", message.body)
